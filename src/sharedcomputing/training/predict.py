...
from sharedcomputing.core.paths import CHECKPOINT_BEST_NET

# ── Config ────────────────────────────────────────────────────────────────────
CKPT_PATH  = CHECKPOINT_BEST_NET
IMG_SIZE   = 224
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("  Example: python3 predict.py test.jpg  (or scripts/run_predict.py)\n")
        sys.exit(1)
